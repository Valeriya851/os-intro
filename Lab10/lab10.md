...
*9. Какой редактор вам показался удобнее в работе vi или emacs? Поясните почему.*

Emacs — текстовый редактор. Текстовый редактор с колоссальными возможностями для расширения. Многие редакторы в той или иной мере расширяемы, в случае же Emacs важна именно степень расширяемости. Именно она выделяет его среди многих других.
